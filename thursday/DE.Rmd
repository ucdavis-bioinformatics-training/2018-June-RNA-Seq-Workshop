...
```{r}
counts <- read.table(file = "https://raw.githubusercontent.com/ucdavis-bioinformatics-training/2018-June-RNA-Seq-Workshop/master/thursday/all_counts.txt", header = T, sep = "\t", stringsAsFactors = F)
head(counts)
```
...
In this case, limma is fitting a linear regression model, which in this case is a straight line fit, with the slope and intercept defined by the model coefficients:
```{r}
